 ...
 */
@Resource(name = RestConstants.VERSION_1 + "/flags", order = 2, supportedClass = FlagWrapper.class, supportedOpenmrsVersions = {"1.8.*", "1.9.*", "1.10.*", "1.11.*", "1.12.*"})
...
public class FlagsResource extends BaseDelegatingReadableResource<FlagWrapper> {
	...
	@Override
	public FlagWrapper getByUniqueId(String uniqueId) {
		// TODO Auto-generated method stub
		return null;
	}
}
